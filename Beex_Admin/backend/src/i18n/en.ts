...
const en = {
  ...
  entities: {
    ...
    conta: {
      errors: {
        unique: {
          idMetatraderCorretora: 'IdMetatraderCorretora must be unique',
        }
      }
    },
    plano: {
      errors: {
        unique: {
          nome: 'Nome must be unique',
          qtdDeContratos: 'QtdDeContratos must be unique',
        }
      }
    },
    ordem: {
    ...
    checkList: {
      errors: {
        unique: {
          cliente: 'Cliente must be unique',
          clienteId: 'Cliente must be unique',
        }
      }
    },
    planoPeriodo: {
