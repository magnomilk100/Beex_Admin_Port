...
const ptBR = {
  ...
  entities: {
    ...
    conta: {
      errors: {
        unique: {
          idMetatraderCorretora: 'IdMetatraderCorretora deve ser único',
        }
      }
    },
    plano: {
      errors: {
        unique: {
          nome: 'Nome deve ser único',
          qtdDeContratos: 'QtdDeContratos deve ser único',
        }
      }
    },
    ordem: {
    ...
    checkList: {
      errors: {
        unique: {
          cliente: 'Cliente deve ser único',
          clienteId: 'Cliente deve ser único',
        }
      }
    },
    planoPeriodo: {
