const es = {
  ...
  entities: {
    ...
    conta: {
      errors: {
        unique: {
          idMetatraderCorretora: 'IdMetatraderCorretora debe ser único',
        }
      }
    },
    plano: {
      errors: {
        unique: {
          nome: 'Nome debe ser único',
          qtdDeContratos: 'QtdDeContratos debe ser único',
        }
      }
    },
    ordem: {
    ...
    checkList: {
      errors: {
        unique: {
          cliente: 'Cliente debe ser único',
          clienteId: 'Cliente debe ser único',
        }
      }
    },
    planoPeriodo: {
