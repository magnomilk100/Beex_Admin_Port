...
import PlanoPeriodo from '../models/planoPeriodo';
import ParametrosRobo from '../models/parametrosRobo';
...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Cliente(options.database).deleteMany({ tenant: id }, options);

    await Pais(options.database).deleteMany({ tenant: id }, options);

    await Corretora(options.database).deleteMany({ tenant: id }, options);

    await Conta(options.database).deleteMany({ tenant: id }, options);

    await Plano(options.database).deleteMany({ tenant: id }, options);

    await Ordem(options.database).deleteMany({ tenant: id }, options);

    await Robo(options.database).deleteMany({ tenant: id }, options);

    await Pedido(options.database).deleteMany({ tenant: id }, options);

    await RegistroDiario(options.database).deleteMany({ tenant: id }, options);

    await CheckList(options.database).deleteMany({ tenant: id }, options);

    await PlanoPeriodo(options.database).deleteMany({ tenant: id }, options);

    await ParametrosRobo(options.database).deleteMany({ tenant: id }, options);
