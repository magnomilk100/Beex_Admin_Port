...
require('./pais').default(routes);
require('./corretora').default(routes);
require('./conta').default(routes);
require('./plano').default(routes);
require('./ordem').default(routes);
require('./robo').default(routes);
require('./pedido').default(routes);
require('./registroDiario').default(routes);
require('./checkList').default(routes);
require('./planoPeriodo').default(routes);
require('./parametrosRobo').default(routes);
