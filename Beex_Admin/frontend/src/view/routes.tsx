...
const privateRoutes = [
...

  {
    path: '/plano-periodo',
    loader: () =>
      import('src/view/planoPeriodo/list/PlanoPeriodoListPage'),
    permissionRequired: permissions.planoPeriodoRead,
    exact: true,
  },
  {
    path: '/plano-periodo/new',
    loader: () =>
      import('src/view/planoPeriodo/form/PlanoPeriodoFormPage'),
    permissionRequired: permissions.planoPeriodoCreate,
    exact: true,
  },
  {
    path: '/plano-periodo/importer',
    loader: () =>
      import(
        'src/view/planoPeriodo/importer/PlanoPeriodoImporterPage'
      ),
    permissionRequired: permissions.planoPeriodoImport,
    exact: true,
  },
  {
    path: '/plano-periodo/:id/edit',
    loader: () =>
      import('src/view/planoPeriodo/form/PlanoPeriodoFormPage'),
    permissionRequired: permissions.planoPeriodoEdit,
    exact: true,
  },
  {
    path: '/plano-periodo/:id',
    loader: () =>
      import('src/view/planoPeriodo/view/PlanoPeriodoViewPage'),
    permissionRequired: permissions.planoPeriodoRead,
    exact: true,
  },

  {
    ...
    loader: () =>
      import('src/view/parametrosRobo/list/ParametrosRoboListPage'),
    permissionRequired: permissions.parametrosRoboRead,
    exact: true,
  },
  {
    path: '/parametros-robo/new',
    loader: () =>
      import('src/view/parametrosRobo/form/ParametrosRoboFormPage'),
    permissionRequired: permissions.parametrosRoboCreate,
    exact: true,
  },
  {
    path: '/parametros-robo/importer',
    loader: () =>
      import(
        'src/view/parametrosRobo/importer/ParametrosRoboImporterPage'
      ),
    permissionRequired: permissions.parametrosRoboImport,
    exact: true,
  },
  {
    path: '/parametros-robo/:id/edit',
    loader: () =>
      import('src/view/parametrosRobo/form/ParametrosRoboFormPage'),
    permissionRequired: permissions.parametrosRoboEdit,
    exact: true,
  },
  {
    path: '/parametros-robo/:id',
    loader: () =>
      import('src/view/parametrosRobo/view/ParametrosRoboViewPage'),
    permissionRequired: permissions.parametrosRoboRead,
    exact: true,
  },
].filter(Boolean);
