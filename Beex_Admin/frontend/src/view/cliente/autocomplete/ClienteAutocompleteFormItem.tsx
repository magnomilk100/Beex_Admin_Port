...
import ClienteFormModal from 'src/view/cliente/form/ClienteFormModal';
import AutocompleteInMemoryFormItem from 'src/view/shared/form/items/AutocompleteInMemoryFormItem';
import { useFormContext } from 'react-hook-form';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/cliente/clienteSelectors';

function ClienteAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return ClienteService.listAutocomplete(value, limit);
  };
...
export default ClienteAutocompleteFormItem;
