...
import actions from 'src/modules/pais/list/paisListActions';
...
function PaisToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    paisSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    paisSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=pais"
