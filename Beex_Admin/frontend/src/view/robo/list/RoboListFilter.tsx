...
const schema = yup.object().shape({
  ...
  ativo: yupFilterSchemas.enumerator(
...
const previewRenders = {
  ...
  ativo: {
    ...
    render: filterRenders.enumerator('entities.robo.enumerators.ativo',),
  },
}

function RoboListFilter(props) {
