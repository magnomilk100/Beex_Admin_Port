...
const schema = yup.object().shape({
  ...
  corretora: yupFilterSchemas.relationToOne(
    i18n('entities.conta.fields.corretora'),
  ),
  idMetatraderCorretora: yupFilterSchemas.string(
...
function ContaListFilter(props) {
...
export default ContaListFilter;