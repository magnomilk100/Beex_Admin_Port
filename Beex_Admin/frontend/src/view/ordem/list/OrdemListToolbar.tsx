...
function OrdemToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    ordemSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    ordemSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=ordem"
